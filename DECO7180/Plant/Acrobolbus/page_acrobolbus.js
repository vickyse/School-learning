$(document).ready(function () {
    // A few key messages on the left side of the load
    let url = 'https://apps.des.qld.gov.au/species/?op=getspeciesinformation&taxonid=35794';
    $.ajax({
      url: url,
  ...
  // otherwise errors may occur at runtime
  var lists = new Array()  
