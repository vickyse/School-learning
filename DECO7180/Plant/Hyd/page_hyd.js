$(document).ready(function () {
    let url = 'https://apps.des.qld.gov.au/species/?op=getspeciesinformation&taxonid=20872';
    $.ajax({
      url: url,
      ...
      success: function (data) {
        ...
        $('#NvcStatus').html(item.ConservationStatus.NCAStatus)
      },
      error: function () {
    ...
    function loadNextData() {
      if (urls.length > 0) {
        ...
        loadData(url, function (data) {
          ...
          // Display the data to the area in the corresponding rows
